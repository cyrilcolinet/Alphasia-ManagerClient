...
public class MainSubscriber extends JedisPubSub {
    ...
    public void onPUnsubscribe(String pattern, int subscribedChannels) {
        AlphaManagerClient.log(Level.INFO, "UnSubscribed from pattern " + pattern);
    }

    @Override
    public void onUnsubscribe(String channel, int subscribedChannels) {
        AlphaManagerClient.log(Level.INFO, "UnSubscribed from channel " + channel);
    }

    @Override
    public void onSubscribe(String channel, int subscribedChannels) {
        AlphaManagerClient.log(Level.INFO, "Subscribed on channel " + channel);
    }

    @Override
    public void onPSubscribe(String pattern, int subscribedChannels) {
        AlphaManagerClient.log(Level.INFO, "Subscribed on pattern " + pattern);
    }
