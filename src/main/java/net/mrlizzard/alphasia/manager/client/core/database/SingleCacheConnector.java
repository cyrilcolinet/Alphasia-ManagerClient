package net.mrlizzard.alphasia.manager.client.core.database;

import net.mrlizzard.alphasia.manager.client.AlphaManagerClient;
import net.mrlizzard.alphasia.manager.client.core.database.handlers.MainSubscriber;
...
public class SingleCacheConnector extends CachingConnector {
    ...
    public SingleCacheConnector(String cacheIp, String password) {
        ...
        AlphaManagerClient.log(Level.INFO, "Starting redis (single) caching connection.");
    ...
    public void initiateConnections() throws InterruptedException {
        ...
        AlphaManagerClient.log(Level.INFO, "Connection initialized.");
    ...
    @Override
    public void disable() {
        AlphaManagerClient.log(Level.INFO, "Killing cache subscriptions...");
        commandsSubscriber.unsubscribe();
        commandsSubscriber.punsubscribe();
        AlphaManagerClient.log(Level.INFO, "Closing cache subscriber connection...");
        thread.disable();
        AlphaManagerClient.log(Level.INFO, "Removing cache pools...");
        killConnections();
    }
